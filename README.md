...
If the notebook is hosted on GitHub, you can quickly open it in VSCode's web version. For example, if the notebook is located at this URL: [https://github.com/AU-AIST-2110-Instructors/InClass-Examples/blob/main/Week01-TheBasics/test.ipynb](https://github.com/AU-AIST-2110-Instructors/InClass-Examples/blob/main/Week01-TheBasics/test.ipynb),

you can simply change `github.com` to `github.dev`, like this: [https://github.dev/AU-AIST-2110-Instructors/InClass-Examples/blob/main/Week01-TheBasics/test.ipynb](https://github.dev/AU-AIST-2110-Instructors/InClass-Examples/blob/main/Week01-TheBasics/test.ipynb).
